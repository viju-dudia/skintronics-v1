...
The product is described as helping to:
...
> **Reference only - not approved as specifications or claims for our product.**  
> Page reviewed: [PROTOUCH Spectra Glow 7-Advanced LED Light Face Mask](https://protouchskin.com/products/protouch-spectra-glow-7-mode-led-face-mask)  
> Accessed: 2026-09-03

This is the closest comparable LED-mask product found on ProTouch's website. Use it to inform page organization, feature presentation, usage education, and appropriately qualified copy. Do not copy its brand, specifications, commercial terms, reviews, endorsements, or outcome claims into our product content without owner confirmation.

### Reference positioning

ProTouch describes Spectra Glow as an at-home, multi-spectrum LED light-therapy device intended to help clear, calm, and illuminate the appearance of the skin. Its benefit groupings are:

- Firm and smooth: supports firmer, smoother-looking skin and improved elasticity
- Clarify and balance: supports clearer, more balanced-looking skin
- Brighten and even: promotes a more even-looking tone and natural radiance
- Refresh and revive: refreshes tired-looking skin
- Clear and renew: combines red and blue light for clearer, smoother-looking skin
- Calm and radiance: helps reduce the appearance of skin stress and redness

### Reference specifications

| Attribute | ProTouch page detail |
| --- | --- |
| Product name | PROTOUCH Spectra Glow 7-Advanced LED Light Face Mask |
| LED count | 210 LEDs |
| Light modes | 7: red, blue, green, yellow, purple, cyan, and white |
| Intensity | 5 adjustable levels |
| Session | 10 minutes with automatic shut-off |
| Recommended frequency | 3-5 sessions per week |
| Weight | Approximately 145 g |
| Design | Lightweight, cordless, soft flexible silicone |
| Charging port | USB-C |
| Charging time | 4-5 hours |

### Reference wavelength presentation

| Light | Wavelength shown | ProTouch's stated positioning |
| --- | --- | --- |
| Red | 630-660 nm | Collagen support, firmness, and fine-line care |
| Blue | 415-445 nm | Helps target acne bacteria and excess sebum |
| Green | 520-530 nm | Tone balancing for dark spots, dull patches, and pigmentation |
| Yellow | 570-590 nm | Glow support for tired, puffy, or stressed-looking skin |
| Purple | 380-420 nm | Renewal support combined with skin clarity |
| Cyan | 480-500 nm | Soothing support for visible redness, sensitivity, and discomfort |
| White | Full spectrum | Overall freshness, radiance, and daily maintenance |

The page's interactive red-light example also displays **650 nm**, which sits inside its stated 630-660 nm range.

### Reference usage flow

1. Start with clean, dry skin and remove makeup and residue.
2. Long-press the power button, select one of seven modes with the mode control, and choose one of five intensity levels.
3. Secure the adjustable head strap and use the device for its 10-minute automatic session.
4. Apply a serum or moisturizer after the session.

The ProTouch FAQ says multiple modes may be used in separate sessions with a short break between treatments. It advises sensitive-skin users to begin at a lower intensity and increase according to comfort.

### Reference safety and classification

- ProTouch states that Spectra Glow is a **cosmetic beauty device**, not a medical device, and is not intended to diagnose, treat, or cure a medical condition.
- Its page says the device is not suitable during pregnancy or for users with metal dental implants or electronic implants.
- These warnings belong to the ProTouch reference product. They highlight information our product also needs from its own manufacturer; they are not automatically valid or complete instructions for our product.

### Reference package contents

- Spectra Glow LED face mask: 1
- Adjustable head strap: 1
- USB charging cable: 1
- User manual: 1
- Protective eye pads: 2
- Remote controller: 1

### Reference commercial and proof claims

The following were visible on 2026-09-03 and are recorded only as a time-sensitive reference snapshot:

- Listed sale price: INR 4,499, reduced from INR 4,900 (8% shown), inclusive of taxes
- Additional INR 50 discount shown for prepaid purchases
- One-year warranty, fast/free shipping, secure checkout, and “dermatologist approved” were promoted
- The page claims visible results in 2-4 weeks with consistent use

Do not reuse these prices, offers, warranty terms, endorsements, or results timelines for our product.

### Reference page structure worth adapting

- Product gallery, name, price, offer, and purchase action
- Short outcome-led product description
- Scannable “why you'll love it” specification list
- Interactive light-mode and wavelength explainer
- Concern-based results categories and testimonials
- Four-step usage ritual
- Technology and material explanation
- Package-contents section
- Technical-specifications table
- Product-specific FAQ, including safety and device classification
- Reviews and expert content only where identity, permission, and substantiation are available

### Important differences from our primary source
